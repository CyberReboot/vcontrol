...
# install vent
RUN curl -L https://github.com/CyberReboot/vent/releases/download/v0.2.1/vent.iso >boot2docker.iso && mkdir -p /root/.docker/machine/ && mv boot2docker.iso /root/.docker/machine/boot2docker.iso
