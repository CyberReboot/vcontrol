...
Want to hack on Vcontrol? Awesome! Here are instructions to get you started.
...
issue](#placeholder) before anybody
...
Short answer: with pull requests to the Vcontrol repository.

All decisions affecting Vcontrol, big and small, follow the same 3 steps:
...
* 2) Be available to anyone with questions, bug reports, criticism etc. on Vcontrol.
